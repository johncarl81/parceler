...
*/
public class ParcelableImplementationReadWriteGenerator extends ReadWriteGeneratorBase {

    public ParcelableImplementationReadWriteGenerator(String readMethod, String writeMethod, String parcelableType) {
    ...
    public JExpression generateReader(JBlock body, JVar parcelParam, ASTType type, JClass returnJClassRef, JDefinedClass parcelableClass, JVar identity, JVar readIdentityMap) {
        return returnJClassRef.staticRef("CREATOR").invoke("createFromParcel").arg(parcelParam);
    }
    ...
    public void generateWriter(JBlock body, JExpression parcel, JVar flags, ASTType type, JExpression getExpression, JDefinedClass parcelableClass, JVar writeIdentitySet) {
        body.invoke(getExpression, "writeToParcel").arg(parcel).arg(flags);
    }
}
