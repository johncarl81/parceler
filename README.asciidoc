...
If you use gradle or maven then you **don't need** to specify anything in your proguard configuration file.

If you're not sure that you use latest android tools then add next lines to your configuration file:
